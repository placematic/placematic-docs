...
**"Google can't do this at all."**
It can, since August 2026, in the 48 contiguous United States — dimensions, gross weight, axle count and hazmat classes. What its documentation lists as unsupported is truck toll prices, speed limits and radioactive cargo, and coverage stops at the contiguous 48. Weight per axle group is the parameter to verify against Google's current reference before assuming either way.
...
**HERE documentation:** [Routing API v8 reference](https://docs.here.com/routing/reference/routing-api-v8-calculateroutes)
