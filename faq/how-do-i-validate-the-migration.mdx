...
Run the gate against both platforms. Since August 2026 both can pass it, and passing it does not mean the constraint sets are equivalent — it means neither will send a tall vehicle under a low bridge. Toll cost, axle-group weight and coverage are separate questions the trap geometry does not ask.
