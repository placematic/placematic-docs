...
**Hold the truck-routing trap tests in CI permanently**, not just during migration. A refactor that drops `truck[height]` from a params dict is invisible in code review.
