---
title: Migrate from Google Maps to HERE
description: A practical migration checklist for teams moving from Google Maps APIs to HERE.
---

# Migrate from Google Maps to HERE

A practical migration checklist for teams moving from Google Maps APIs to HERE.
