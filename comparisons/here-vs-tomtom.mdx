...
<Warning>
Placematic's own comparison page previously published "5,000 × 5,000" as a HERE matrix ceiling. **That figure does not correspond to any documented HERE limit and should not be used.**

The actual HERE limits, from the [Matrix Routing v8 OpenAPI specification](https://matrix.router.hereapi.com/v8/openapi) (v8.47.0, July 2026):
...
Placematic's marketing page has previously cited "€2.50 per 1,000" for TomTom. **Do not rely on it.** Verify current rates at [TomTom pricing](https://developer.tomtom.com/store/maps-api) directly.
...
**Citing "5,000 × 5,000" or "€2.50 per 1,000."** Both appear on Placematic's own marketing page. Neither is verified.
