...
**[Authentication](/getting-started/authentication)** — your customers never see a HERE key. Your platform holds one credential. Their access control is yours to build.
...
**Evaluate asset-based pricing** if your customers' vehicle populations are countable and their call volumes are not. See [HERE Pricing Explained](/getting-started/here-pricing-explained).
...
Also: [Reducing Google Maps Costs](/use-cases/reducing-google-maps-costs) · [Getting a HERE API Key](/getting-started/getting-a-here-api-key) · [Truck Routing](/guides/truck-routing)
