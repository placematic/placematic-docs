...
Both EV routing and EV Charge Points bill separately. Confirm entitlement for both. See [HERE Pricing Explained](/getting-started/here-pricing-explained).
...
Also: [Fleet Routing](/use-cases/fleet-routing) · [Truck Routing](/guides/truck-routing) · [Getting a HERE API Key](/getting-started/getting-a-here-api-key)
