...
For a platform with a countable tracked-asset population, evaluate **asset-based pricing** against call-volume. A TMS billing per shipment but paying per API call has a margin structure that inverts under load. See [HERE Pricing Explained](/start-here/here-pricing-explained).
