...
**Restrict browser-exposed keys by domain.** Any key in frontend JavaScript is public. See [Authentication](/getting-started/authentication).
...
See the packaged solution for your industry: [SaaS & Product Teams](https://placematic.com/solutions/saas-teams/)
