...
- **You route commercial vehicles beyond the contiguous United States, under axle-group weight regulation, or with toll cost in the dispatch decision.** Trucks, vans over 3.5t, hazmat, oversized loads. Google added a truck profile for the contiguous 48 in August 2026; the constraint tail and the coverage boundary are where the platforms still diverge.
