...
**Commercial vehicle routing depth and coverage.** Truck constraints — height, gross weight, axle count, weight per axle group, trailer count, tunnel category, hazmat class — are first-class routing inputs in 200+ countries. Google added Large Vehicle Routing in August 2026 with dimensions, gross weight, axle count and hazmat classes, for the 48 contiguous US states. What its documentation lists as unsupported: truck toll prices, speed limits, radioactive cargo. There is no offline navigation. The gap is now the constraint tail and the coverage boundary, not the existence of a truck profile.
...
|---|---|---|
| **Truck routing** | Full profile, 200+ countries | Since Aug 2026, 48 contiguous US states |
| **Truck toll cost** | Toll Cost via Routing v8 | Not supported |
| **Offline truck navigation** | HERE SDK Navigate Edition | Not available |
...
Yes, since August 2026 — Large Vehicle Routing, in the 48 contiguous United States, with dimensions, gross weight, axle count and hazmat classes. Its documentation lists truck toll prices, speed limits and radioactive cargo as unsupported, and there is no offline navigation. Three questions decide it: do your lanes leave the contiguous 48, do you need toll cost before dispatch, does your driver app work offline. A yes to any one of them settles it.
...
Also relevant: [What is HERE Location Services?](/getting-started/what-is-here-location-services) · [Getting a HERE API Key](/getting-started/getting-a-here-api-key)
