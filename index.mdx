...
Placematic has been a HERE Gold Partner since 2016, deploying HERE into production routing engines, ELD platforms, and field operations tools. GreenLight ELD (Joliet, IL) runs on it.
