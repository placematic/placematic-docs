---
title: "Toll Cost"
description: "Calculating toll cost with HERE Routing v8 — why the number changes when you describe the vehicle, what it costs to request, and the dispatch decision that depends on it."
---
