...
**Rate limits are commercial.** A persistent `429` means your quota does not match your workload. See [Authentication](/getting-started/authentication).
...
Also: [Authentication](/getting-started/authentication) · [HERE vs Google Maps](/comparisons/here-vs-google-maps)
